...
CREATE TABLE `user` (
  ...
  `role` enum('super_admin','admin','vendor','manager') COLLATE utf8mb4_general_ci NOT NULL,
  `created_by` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `activeStatus` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
