...
CREATE TABLE `rider_details` (
  ...
  `vehicle_number` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `driving_license_number` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `vehicle_photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `driving_license_photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `aadhar_card` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pancard` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
